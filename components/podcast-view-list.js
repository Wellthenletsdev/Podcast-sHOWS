...
class Component extends LitElement {
    ...
    render() {
        ...
        const viewWatchLaterHandler = () => store.loadWatchLaterList();
        ...
        const list = sortedPreviews.map(({ title, id, updated, image }) => {
            ...
            return html`
                <li list-style-type='none' class="podcast-list-items">
        ...
        return html`
            <button @click="${viewWatchLaterHandler}">Watch Later</button>
            <h1>Podcast List</h1>
